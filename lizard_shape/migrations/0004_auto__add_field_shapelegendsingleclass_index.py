...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShapeLegendSingleClass.index'
        db.add_column('lizard_shape_shapelegendsingleclass', 'index', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShapeLegendSingleClass.index'
        db.delete_column('lizard_shape_shapelegendsingleclass', 'index')
    ...
    models = {
        ...
        'lizard_shape.shapelegendsingleclass': {
            'Meta': {'ordering': "('index',)", 'object_name': 'ShapeLegendSingleClass'},
