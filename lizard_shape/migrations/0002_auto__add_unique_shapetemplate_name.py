...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ShapeTemplate', fields ['name']
        db.create_unique('lizard_shape_shapetemplate', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ShapeTemplate', fields ['name']
        db.delete_unique('lizard_shape_shapetemplate', ['name'])
